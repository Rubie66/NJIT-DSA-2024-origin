...
public class PerformanceTests {
    ...
    private static final String[] testFiles = { "word.txt", "tiny.txt", "small.txt", "MetaMorph.txt", "Species.txt",
            "Ulysses.txt", "WarPeace.txt", "Bulk.txt", "sapmirussian.txt", "japanese.txt" };
